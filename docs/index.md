...
v0.1 is the first usable release: GMAT (R2022a, R2025a, or R2026a) on Linux runners (`ubuntu-latest`), caching across runs, and a built-in smoke check that loads and runs a stock GMAT sample. Windows and macOS support is scoped for v0.2; see the [README roadmap](https://github.com/astro-tools/setup-gmat#roadmap) for the full plan.
